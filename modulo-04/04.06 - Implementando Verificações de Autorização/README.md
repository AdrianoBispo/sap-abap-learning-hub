...
3. Criar e manter controles de acesso automáticos ("Row-Level Security") em CDS Views utilizando **DCL (Data Control Language)** e a função de aspecto pfcg_auth.  
...
Quando qualquer programa (Fiori, GUI, API) executa SELECT * FROM Z_I_TRAVEL, o banco de dados verifica o usuário atual. Se o usuário tiver acesso apenas à agência '001', o banco reescreve a query internamente para:  
