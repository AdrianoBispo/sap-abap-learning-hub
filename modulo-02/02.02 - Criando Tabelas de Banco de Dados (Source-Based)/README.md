...
Q1: Por que a chave primária técnica recomendada para novas tabelas no modelo RAP é um UUID (sysuuid_x16) em vez de um número sequencial semântico (como Número do Pedido)?  
...
Q3: Qual é a implicação de definir a anotação @AbapCatalog.dataMaintenance como #RESTRICTED ou #NOT_ALLOWED?  
