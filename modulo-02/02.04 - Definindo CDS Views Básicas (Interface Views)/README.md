...
- Utilizar **Aliases** estrategicamente para converter nomes técnicos legados (ex: MATNR) para nomes semânticos em **CamelCase** (ex: MaterialID), facilitando o consumo por interfaces web (UI5/Fiori).  
...
4. Para que serve a anotação @Semantics.user.createdBy: true em um cenário RAP Managed?  
